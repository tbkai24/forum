...
$categories = $conn->query("SELECT 
    ...
    COUNT(topics.id) AS count_category 
FROM categories 
    ...
    <div class="sidebar">
        <div class="block">
            ...
            <div class="list-group block ">
                <a href="http://localhost/forum/" class="list-group-item active">All Topics <span class="badge pull-right"><?php echo $allTopics->all_topics; ?></span></a> 
        ...
        <div class="block" style="margin-top: 20px;">
            ...
            <div class="list-group">
                ...
                <a href="#" class="list-group-item">Total Number of Topics:<span class="color badge pull-right"><?php echo $allTopics_count->count_topics; ?></php></span></a>
